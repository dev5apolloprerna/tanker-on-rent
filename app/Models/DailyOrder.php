...
class DailyOrder extends Model
{
    ...
    protected $keyType = 'int';
        ...
        protected $fillable = [
          'customer_id', 'customer_name', 'mobile', 'location', 'rent_date','tanker_id' ,'placed_the_tanker', 'empty_the_tanker', 'filled_the_tanker', 'extra_amount', 'total_amount','isPaid','iStatus'
        ];
