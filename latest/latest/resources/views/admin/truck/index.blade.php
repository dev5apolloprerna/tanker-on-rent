                    ...
                    <form id="bulkDeleteForm" method="POST" action="{{ route('truck.bulkDelete') }}">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Truck List</h5>
                                <!--<div class="d-flex">
                                    <input type="text" name="truck_name" class="form-control me-2" placeholder="Truck Name" value="{{ request('truck_name') }}">
                                    <input type="text" name="truck_number" class="form-control me-2" placeholder="Truck Code" value="{{ request('truck_number') }}">
