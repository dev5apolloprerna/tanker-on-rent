...
public function index(Request $request)
{
     ...
     public function store(Request $request)
    {
        ...
        $order = DB::transaction(function () use ($request, $customerId, $customerName, $mobile) {
        ...
        // ✅ Now $order exists here
        $this->syncTankerStatus(
            (int) $order->tanker_id,
            (string) $order->tanker_location
        );
    
        return redirect()
            ->route('daily-orders.index')
